...
#' @param searchWord Keyword for searching. You can use `OR` and `AND`. (e.g.: `apple AND orrange`).
...
#'        (default: `TRUE`)
#' @param surveyYears Year and month when the survey was conducted. The format is either `YYYY`, `YYYYMM`, or `YYYYMM-YYYYMM`
#' @param openYears Year and month when the survey result was opened. The format is the same as `surveyYears`
...
#'    <http://www.soumu.go.jp/toukei_toukatsu/index/seido/sangyo/26index.htm>
...
#'
#' @seealso
#' <http://www.e-stat.go.jp/api/e-stat-manual2-1/#api_2_1>
#' <http://www.e-stat.go.jp/api/e-stat-manual2-1/#api_3_2>
#'
#' @examples
#' \dontrun{
#' estat_getStatsList(
